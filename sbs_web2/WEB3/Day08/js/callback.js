...
$(document).ready(function(){
    ...
    //fadeToggle() : 노출이 되엉 ㅣㅆ는 요소는 점점 사라지고, 사라져있는 요소는 점점 노출되어 선명해지는 기능
    ...
    $(".btns1").on("click",function(){
        $(".img3").fadeTo(1000,1);//인수값1 :구동시간/ 2:투명도 값
    });
    ...
    //slideToggle() : 요소가 나타나 있으면 숨기고, 숨겨져 있으면 나태는 기능
